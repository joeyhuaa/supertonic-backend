...
class AudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post audios_url, params: { audio: { duration: @audio.duration, file: @audio.file, name: @audio.name } }
    end
  ...
  test "should update audio" do
    patch audio_url(@audio), params: { audio: { duration: @audio.duration, file: @audio.file, name: @audio.name } }
